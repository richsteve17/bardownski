...
export default function MatchView({ lineup, momentum, chemistry, powerPlayBuff = false, onMatchEnd }) {
  const [log, setLog] = useState([]);
  const [isSimulating, setIsSimulating] = useState(false);

  const startShift = () => {
    setIsSimulating(true);
    const result = simulateShift(lineup, momentum, chemistry, { powerPlayBuff });
